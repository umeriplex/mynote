package com.example.quoto.adapters
...
import com.example.quoto.databinding.NoteItemBinding

class NoteAdapter() : androidx.recyclerview.widget.ListAdapter<NoteResponse, NoteAdapter.NoteViewHolder>(ComparatorDiffUtil()) {
